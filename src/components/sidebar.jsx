  ...
  return (
    <li
      className={`
        ...
        ${
          active
            ? "bg-linear-to-tr from-indigo-200 to-indigo-10 text-white"
            : "text-white hover:bg-linear-to-tr from-indigo-200 to-indigo-10 hover:text-black"
        }
    `}
    >
      {icon}
      <span
        className={`overflow-hidden transition-all ${
          expanded ? "w-52 ml-3 text-sm" : "w-0"
        }`}
      >
        {text}
      </span>
